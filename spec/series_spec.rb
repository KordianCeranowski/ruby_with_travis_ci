...
RSpec.describe Series do
	RSpec.describe '.slices' do
		...
		context 'checking if double slices of input number generate correct list' do
		...
		context 'checking if triple and more slices of input number generate correct list' do
		...
		context 'when slice size is bigger than number length' do
